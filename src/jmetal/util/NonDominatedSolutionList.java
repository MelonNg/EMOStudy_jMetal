        ...
        if (solutionsList_.size() == 0) {
            ...
            while (iterator.hasNext()) {
                ...
                if (flag == -1) {  // A solution in the list is dominated by the new one
                    iterator.remove();
                    listIndividual.setNondominated(false);
...
//                    }
                    ...
                    solution.setNondominated(false);
                    return false;
                }
            } // while
            //} // if
    ...
    public void addWithoutCheck(Solution solution) {
        solutionsList_.add(solution);
    } // add
} // NonDominatedList
