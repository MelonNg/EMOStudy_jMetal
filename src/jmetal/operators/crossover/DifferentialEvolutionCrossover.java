...
//                        value = xChild.getUpperBound(j);
                    if (value < xChild.getLowerBound(j)) {
                        ...
                        value = xChild.getLowerBound(j) + rnd *(xCurrent.getValue(j) - xChild.getLowerBound(j)) ;
                    }
                    if (value > xChild.getUpperBound(j)) {
                        double rnd = PseudoRandom.randDouble(0, 1) ;
                        value = xChild.getUpperBound(j) - rnd*(xChild.getUpperBound(j)-xCurrent.getValue(j)) ;
                    }
