...
import jmetal.metaheuristics.moead.MOEAD_IPBI;
import jmetal.metaheuristics.moead.MOEAD_IPBI_SBX;
 ...
 */
public class MOEAD_IPBI_SBX_Settings extends Settings {
     ...
     * Constructor
     */
    public MOEAD_IPBI_SBX_Settings(String problem) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new MOEAD_IPBI_SBX(problem_);
