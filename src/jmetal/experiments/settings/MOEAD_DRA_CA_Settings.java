...
import jmetal.metaheuristics.moead.MOEAD_DRA_AMOSTM;
 ...
 */
public class MOEAD_DRA_CA_Settings extends Settings {
    public double CR_;
    public double F_;
     ...
     * Constructor
     */
    public MOEAD_DRA_CA_Settings(String problem) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new MOEAD_DRA_AMOSTM(problem_);
