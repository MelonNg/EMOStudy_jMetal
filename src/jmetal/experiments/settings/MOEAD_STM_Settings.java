...
import jmetal.metaheuristics.moead.MOEAD_STM;
 ...
 */
public class MOEAD_STM_Settings extends Settings {
    public double CR_ ;
    public double F_  ;
     ...
     * Constructor
     */
    public MOEAD_STM_Settings(String problem) {
        this(problem, "Real");
    }

    public MOEAD_STM_Settings(String problem, String solutionType) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new MOEAD_STM(problem_);
