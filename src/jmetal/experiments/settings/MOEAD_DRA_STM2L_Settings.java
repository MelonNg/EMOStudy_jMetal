...
import jmetal.metaheuristics.moead.MOEAD_DRA_STM2L;
 ...
 */
public class MOEAD_DRA_STM2L_Settings extends Settings {
    public double CR_ ;
    public double F_  ;
     ...
     * Constructor
     */
    public MOEAD_DRA_STM2L_Settings(String problem) {
        this(problem, "Real");
    }

    public MOEAD_DRA_STM2L_Settings(String problem, String solutionType) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new MOEAD_DRA_STM2L(problem_);
        ...
        algorithm.setInputParameter("r", r_) ;
    ...
    public Algorithm configure(Properties configuration) throws JMException {
        ...
        r_ = Integer.parseInt(configuration.getProperty("r", String.valueOf(r_)));
