...
import jmetal.metaheuristics.moead.MOEAD_DRA_AOOSTM;
 ...
 */
public class MOEAD_DRA_ASTM_Settings extends Settings {
    public double CR_;
    public double F_;
     ...
     * Constructor
     */
    public MOEAD_DRA_ASTM_Settings(String problem) {
        super(problem);
    ...
    public Algorithm configure() throws JMException {
        ...
        algorithm = new MOEAD_DRA_AOOSTM(problem_);

        // Algorithm parameters
        algorithm.setInputParameter("populationSize", populationSize_);
        algorithm.setInputParameter("maxEvaluations", maxEvaluations_);
        algorithm.setInputParameter("T", T_);
        algorithm.setInputParameter("lmax", lmax_);
    ...
    private void defaultSetting(String problem) {
        ...
        try {
            if (problem.startsWith("WFG")) {
                ...
                if (numberOfObjectives == 2) {
                    ...
                    Object[] problemParams = {"Real", 2, 4, 2};
        ...
        crossoverDistributionIndex_ = 30;
