...
public class Solution implements Serializable {
    ...
    /**
     * Stores whether the solution is nondominated in the population
     */
    private boolean nondominated_;

    /**
     * Stores the closest subproblem index
     */
    private int closestSubp;
    ...
    public Solution(Solution solution) {
        ...
        nondominated_ = solution.isNondominated();
    ...
    public void setNondominated(boolean nondominated) {
        this.nondominated_ = nondominated;
    }

    public int getClosestSubp() {
        return closestSubp;
    }

    public void setClosestSubp(int closestSubp) {
        this.closestSubp = closestSubp;
    }
} // Solution
