 ...
 */
public class WFG45 extends WFG {
     ...
     */
    public WFG45(String solutionType) throws ClassNotFoundException {
     ...
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public WFG45(String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException {
    ...
    public float[] evaluate(float[] z) {
        ...
        result[M_ - 1] = D_ * x[M_ - 1] + S_[M_ - 1] * (new Shapes()).mixed(x, 2, (float) 1.0);
