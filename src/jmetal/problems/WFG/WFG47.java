 ...
 */
public class WFG47 extends WFG {
     ...
     */
    public WFG47(String solutionType) throws ClassNotFoundException {
     ...
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public WFG47(String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException {
    ...
    public float[] evaluate(float[] z) {
        ...
        result[M_ - 1] = D_ * x[M_ - 1] + S_[M_ - 1] * (new Shapes()).disc(x, 2, (float) 0.5, (float) 0.5);
