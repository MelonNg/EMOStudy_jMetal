 ...
 */
public class WFG43 extends WFG {
     ...
     */
    public WFG43(String solutionType) throws ClassNotFoundException {
     ...
     * @param solutionType The solution type must "Real" or "BinaryReal".
     */
    public WFG43(String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException {
    ...
    public float[] evaluate(float[] z) {
        ...
        for (int m = 1; m <= M_; m++) {
            result[m - 1] = D_ * x[M_ - 1] + S_[m - 1] * (new Shapes()).concave2(x, m);
        }
