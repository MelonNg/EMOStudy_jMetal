 ...
 */
public class MOP6 extends Problem {

    /**
     * Constructor.
     * Creates a default instance of problem MOP6 (10 decision variables)
     *
     ...
     * @param solutionType      The solution type must "Real" or "BinaryReal".
     */
    public MOP6(String solutionType, Integer numberOfVariables) {
    ...
    public void evaluate(Solution solution) throws JMException {
        ...
        solution.setObjective(0, (1.0 + g) * x[0] * x[1]);
        solution.setObjective(1, (1.0 + g) * x[0] * (1.0 - x[1]));
        solution.setObjective(2, (1.0 + g) * (1 - x[0]));
