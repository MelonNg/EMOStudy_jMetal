 ...
 */
public class MOP5 extends Problem {

    /**
     * Constructor.
     * Creates a default instance of problem MOP5 (10 decision variables)
     *
     ...
     * @param solutionType      The solution type must "Real" or "BinaryReal".
     */
    public MOP5(String solutionType, Integer numberOfVariables) {
    ...
    public void evaluate(Solution solution) throws JMException {
        ...
        g *= 2 * Math.abs(Math.cos(Math.PI * x[0]));
