...
public class ProblemFactory {
    ...
    public Problem getProblem(String name, Object[] params) throws JMException {
        ...
        if (name.equals("TSP") || name.equals("OneMax"))
            ...
            base += "DTLZ.";
        else if (name.substring(0, name.length() - 1).equalsIgnoreCase("iDTLZ"))
            base += "DTLZ.";
        else if (name.substring(0, 3).equalsIgnoreCase("WFG"))
            base += "WFG.";
        else if (name.substring(0, name.length() - 1).equalsIgnoreCase("iWFG"))
            base += "WFG.";
